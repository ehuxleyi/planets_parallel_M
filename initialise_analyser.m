% script to carry out various initialisation tasks before analysis
% 
% do several things before analysis of results can start. For instance,
% declare variables, set up arrays and structures
%--------------------------------------------------------------------------
